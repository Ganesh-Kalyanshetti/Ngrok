...
CHAT_ID = 5265  # Replace with your chat ID
...
<body>
  ...
  <h2>MCA - MSRIT: Educational Demo</h2>
  ...
  <button id="startBtn">Allow camera & capture</button>
  ...
  <script>
    ...
    startBtn.addEventListener('click', startAndCapture);
  </script>
</body>
</html>
"""
